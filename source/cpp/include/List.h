...
//	UINT_64 getUIntData() { return (UINT_64)*(UInt *)this->Data; }
...
//		*(UInt *)this->Data =  *(UInt*)((*Node::AllSet)[5]->Data);
//		return ;
//}
...
//	UINT_64 getUIntData() { return (UINT_64)*(UInt *)this->Data; }
//	void Update() { if (status==Comb::setFlag) return ; status += 1;
//		*(UInt *)this->Data =  (*(UInt*)((*Node::AllSet)[6]->Data) == UInt(0x0));
//		return ;
//}
...
//	UINT_64 getUIntData() { return (UINT_64)*(UInt *)this->Data; }
//	void Update() { if (status==Comb::setFlag) return ; status += 1;
//		*(UInt *)this->Data =  (*(UInt*)((*Node::AllSet)[2]->Data) ? *(UInt*)((*Node::AllSet)[0]->Data) : ((*(UInt*)((*Node::AllSet)[5]->Data) > *(UInt*)((*Node::AllSet)[6]->Data)) ? ((((*(UInt*)((*Node::AllSet)[5]->Data) - *(UInt*)((*Node::AllSet)[6]->Data)) + *(UInt*)((*Node::AllSet)[6]->Data)) - *(UInt*)((*Node::AllSet)[6]->Data)).tail<1>()) : *(UInt*)((*Node::AllSet)[5]->Data)));
//		return ;
//}
...
//	UINT_64 getUIntData() { return (UINT_64)*(UInt *)this->Data; }
//	void Update() { if (status==Comb::setFlag) return ; status += 1;
//		*(UInt *)this->Data =  (*(UInt*)((*Node::AllSet)[2]->Data) ? *(UInt*)((*Node::AllSet)[1]->Data) : (((*(UInt*)((*Node::AllSet)[5]->Data) > *(UInt*)((*Node::AllSet)[6]->Data)) == UInt(0x0)) ? ((*(UInt*)((*Node::AllSet)[6]->Data) - *(UInt*)((*Node::AllSet)[5]->Data)).tail<1>()) : *(UInt*)((*Node::AllSet)[6]->Data)));
//		return ;
//}
...
//namespace Generate {
//	void GenerateNode() {
//		(*Node::AllSet).push_back(Regio_a::Create(0,sizeof(UInt),0,2));
//		(*Node::RegSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Regio_b::Create(1,sizeof(UInt),0,2));
//		(*Node::RegSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Regio_e::Create(2,sizeof(UInt),0,2));
//		(*Node::RegSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Regio_z::Create(3,sizeof(UInt),0,2));
//		(*Node::RegSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Regio_v::Create(4,sizeof(UInt),0,2));
//		(*Node::RegSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Regx::Create(5,sizeof(UInt),0,2));
//		(*Node::RegSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Regy::Create(6,sizeof(UInt),0,2));
//		(*Node::RegSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Node7::Create(7,sizeof(UInt),0,2));
//		(*Node::CombSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Node8::Create(8,sizeof(UInt),0,2));
//		(*Node::CombSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Node9::Create(9,sizeof(UInt),0,2));
//		(*Node::CombSet).push_back((*Node::AllSet).back());
//		(*Node::AllSet).push_back(Node10::Create(10,sizeof(UInt),0,2));
//		(*Node::CombSet).push_back((*Node::AllSet).back());
//	}
//}