...
struct IRDecoder {
    ...
    int getTypeID(std::string type) {
        if (type == "wire")
            return FuncType::Wire;
        else if (type == "Node")
            return FuncType::Node;
        else if (type == "Mux")
            return FuncType::Mux;
        else if (type == "UIntLiteral")
            return FuncType::UIntLiteral;
        else if (type == "Eq")
            return FuncType::Eq;
        else if (type == "Port")
            return FuncType::Port;
        else if (type == "Bits")
            return FuncType::Bits;
        else if (type == "And")
            return FuncType::And;
        else if (type == "Reg")
            return FuncType::Reg;
            ...
            return FuncType::Cat;
        else if (type == "ValidIf")
            return FuncType::ValidIf;
        else if (type == "Add")
            return FuncType::Add;
        else if (type == "Tail")
            return FuncType::Tail;
        else if (type == "AsUInt")
            return FuncType::AsUInt;
        else if (type == "Not")
            return FuncType::Not;
        else if (type == "Memen")
            return FuncType::Memen;
        else if (type == "Memdata")
            return FuncType::Memdata;
        else if (type == "Memclk")
            return FuncType::Memclk;
        else if (type == "Memaddr")
            return FuncType::Memaddr;
        else if (type == "Neq")
            return FuncType::Neq;
        else if (type == "Pad")
            return FuncType::Pad;
        else if (type == "Memmask")
            return FuncType::Memmask;
        else if (type == "Lt")
            return FuncType::Lt;
        else if (type == "Geq")
            return FuncType::Geq;
            ...
            return FuncType::Dshr;
        else if (type == "Dshl")
            return FuncType::Dshl;
        else if (type == "Sub")
            return FuncType::Sub;
        else if (type == "Gt")
            return FuncType::Gt;
	...
	*/
    bool getFlag(int typeID) {
        switch (level) {
            case 0:
                return typeID == FuncType::Node || typeID == FuncType::Wire || typeID == FuncType::Reg ||
                       typeID == FuncType::Port;
                break;
            case 1:
                return typeID == FuncType::Wire || typeID == FuncType::Reg || typeID == FuncType::Port;
                break;
            case 2:
                return typeID == FuncType::Reg || typeID == FuncType::Port;
                break;
            default:
                break;
        }
