...
template<typename T> inline T Dshr(T &a, T &b) {}
template<typename T> inline T Dshl(T &a, T &b) {}
template<typename T> inline T Shl(T &a, T &b) {}
template<typename T> inline T Shr(T &a, T &b) {}
